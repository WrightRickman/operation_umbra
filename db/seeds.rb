...
game = yaniv.new_game("Testing Game", 3, 3)
...
Mission.create(:description => "Find a poster or ad for a band.", :level => 1)
Mission.create(:description => "Find a poster or ad for a film.", :level => 1)
Mission.create(:description => "Find a poster or ad for a television show.", :level => 1)
...
Mission.create(:description => "Find a coin older than you are.", :level => 2)
Mission.create(:description => "Throw a penny into a fountain.", :level => 2)
